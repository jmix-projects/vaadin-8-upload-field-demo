package com.company.demo.test_support;

import com.company.demo.VaadinUploadDemoApplication;
...
@ContextConfiguration(classes = {VaadinUploadDemoApplication.class, UiTestAssistConfiguration.class})
